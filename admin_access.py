			...
			try:
				...
				try:
					try:
						...
						self.c.execute("CREATE table general_ledger_place(place_id TEXT, place_name TEXT, value REAL, location TEXT)")
						self.c.execute("CREATE table vender(id TEXT, name TEXT, BSB INT, accoun_num INT, ABN INT, period TEXT, location TEXT, contact TEXT)")
						self.c.execute("CREATE table purchase_order(id TEXT, date_s TEXT, time_s TEXT, total REAL, gst REAL, vender TEXT, user_id TEXT, status TEXT)")
						self.c.execute("CREATE table purchase_order_items(id INT, plu TEXT, description TEXT, quantity REAL, price REAL)")
						self.c.execute("CREATE table vender_ledger_POs(PO_id INT, vender_id INT, amount REAL, gst REAL, time_s TEXT, date_s TEXT, user_id TEXT, due_date TEXT)")
